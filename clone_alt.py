...
def run_script():
    ...
    repo_path = '/content/MicrosoftExcel'
    ...
    def clone_and_copy_repo(repo_path):
        # New repository link
        new_repo_link = "https://github.com/Eddycrack864/Mangio-Eddy-Tweaks.git"
        ...
        run_cmd("git checkout 2bcdc52b1e543f8a202b1da5e130b2e7bc9172ca")
        #ojito
        #########################################################################################
    ...
    os.makedirs('/content/MicrosoftExcel/stats/', exist_ok=True)
    run_cmd("wget -q https://cdn.discordapp.com/attachments/945486970883285045/1114717554481569802/peppy-generator-388800-07722f17a188.json -O /content/MicrosoftExcel/stats/peppy-generator-388800-07722f17a188.json")

    # Forcefully delete any existing torchcrepe dependencies downloaded from an earlier run just in case
    shutil.rmtree('/content/MicrosoftExcel/torchcrepe', ignore_errors=True)
    ...
    shutil.move('/content/torchcrepe/torchcrepe', '/content/MicrosoftExcel/')
    shutil.rmtree('/content/torchcrepe', ignore_errors=True)  # Delete the torchcrepe repository folder

    # Change the current directory to /content/MicrosoftExcel
    os.chdir('/content/MicrosoftExcel')
...
def download_pretrained_models():
    ...
    base_path = "/content/MicrosoftExcel/"
